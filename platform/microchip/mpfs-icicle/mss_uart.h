...
/***************************************************************************//**
  Interrupt type
  The following definitions are used to specify intr_type parameter to the
  MSS_UART_init() function. The value 0 means that the MMUART interrupt is
  treated as local interrupt on E51. The value of 1 means that the MMUART interrupt
  is routed through PLIC
 */
#define MSS_UART0_INTR_LOCAL    0
#define MSS_UART0_INTR_PLIC     1
...
struct mss_uart_instance{
    ...
    uint8_t                 intr_type;   /*!< 0 => local, 1 => PLIC */
...
/***************************************************************************//**
  ...
  @param intr_type
    The intr_type parameter is the line interrupt type which should be used for
    MMUART0. MMUART0 can have local interrupt on E51 or the same interrupt can be
    routed through PLIC. All other MMUART instance can have interrupt only via
    PLIC.

    NOTE: This parameter is applicable only when this_uart = g_mss_uart0_lo or
    this_uart = g_mss_uart0_hi. For all other MMUART instances this parameter is
    ignored.
