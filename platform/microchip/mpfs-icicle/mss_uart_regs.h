...
#define SB_MASK                     (0x01 << SB)        /* Set break */
#define DLAB_MASK                   (0x01 << DLAB)      /* Divisor latch access bit */
...
#define RXRDY_TXRDYN_EN_MASK        (0x01 << 0u)      /* Enable TXRDY and RXRDY signals */
#define CLEAR_RX_FIFO_MASK          (0x01 << 1u)      /* Clear receiver FIFO */
#define CLEAR_TX_FIFO_MASK          (0x01 << 2u)      /* Clear transimtter FIFO */
#define RDYMODE_MASK                (0x01 << 3u)      /* Mode 0 or Mode 1 for TXRDY and RXRDY */
...
#define LOOP_MASK                   (0x01 << 4u)        /* Local loopback */
#define RLOOP_MASK                  (0x01 << 5u)        /* Remote loopback & Automatic echo*/
#define ECHO_MASK                   (0x01 << 6u)        /* Automatic echo */
...
#define DR_MASK                     (0x01 << 0u)        /* Data ready */
#define THRE_MASK                   (0x01 << 5u)        /* Transmitter holding register empty */
#define TEMT_MASK                   (0x01 << 6u)        /* Transitter empty */
...
#define ERBFI_MASK                  (0x01 << 0u)      /* Enable receiver buffer full interrupt */
#define ETBEI_MASK                  (0x01 << 1u)      /* Enable transmitter buffer empty interrupt */
#define ELSI_MASK                   (0x01 << 2u)      /* Enable line status interrupt */
#define EDSSI_MASK                  (0x01 << 3u)      /* Enable modem status interrupt */
...
#define ELIN_MASK                   (0x01 << 3u)      /* Enable LIN header detection */
#define ETTG_MASK                   (0x01 << 5u)      /* Enable transmitter time guard */
#define ERTO_MASK                   (0x01 << 6u)      /* Enable receiver time-out */
#define EFBR_MASK                   (0x01 << 7u)      /* Enable fractional baud rate mode */
...
#define E_MSB_RX_MASK               (0x01 << 0u)      /* MSB / LSB first for receiver */
#define E_MSB_TX_MASK               (0x01 << 1u)      /* MSB / LSB first for transmitter */
#define EIRD_MASK                   (0x01 << 2u)      /* Enable IrDA modem */
#define EIRX_MASK                   (0x01 << 3u)      /* Input polarity for IrDA modem */
#define EITX_MASK                   (0x01 << 4u)      /* Output polarity for IrDA modem */
#define EITP_MASK                   (0x01 << 5u)      /* Output pulse width for IrDA modem */
...
#define EERR_MASK                   (0x01 << 0u)      /* Enable ERR / NACK during stop time */
#define EAFM_MASK                   (0x01 << 1u)      /* Enable 9-bit address flag mode */
#define EAFC_MASK                   (0x01 << 2u)      /* Enable address flag clear */
#define ESWM_MASK                   (0x01 << 3u)      /* Enable single wire half-duplex mode */
...
#define ERTOI_MASK                  (0x01 << 0u)      /* Enable receiver timeout interrupt */
#define ENACKI_MASK                 (0x01 << 1u)      /* Enable NACK / ERR interrupt */
#define EPID_PEI_MASK               (0x01 << 2u)      /* Enable PID parity error interrupt */
#define ELINBI_MASK                 (0x01 << 3u)      /* Enable LIN break interrupt */
#define ELINSI_MASK                 (0x01 << 4u)      /* Enable LIN sync detection interrupt */
